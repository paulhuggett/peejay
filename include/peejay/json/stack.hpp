//===- include/peejay/json/stack.hpp ----------------------*- mode: C++ -*-===//
//*      _             _     *
//*  ___| |_ __ _  ___| | __ *
//* / __| __/ _` |/ __| |/ / *
//* \__ \ || (_| | (__|   <  *
...
template <typename T, typename Container = std::deque<T>> class stack : public std::stack<T, Container> {
public:
...
template <typename Container> stack(Container) -> stack<typename Container::value_type, Container>;

}  // end namespace peejay

template <typename T, typename Container, typename Allocator>
struct std::uses_allocator<peejay::stack<T, Container>, Allocator> : public std::uses_allocator<Container, Allocator> {
};
