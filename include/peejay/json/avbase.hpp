...
protected:
  ...
  static void clear(SizeType *size, pointer_based_iterator<T> first, pointer_based_iterator<T> last) noexcept;

  template <typename SizeType, typename... Args>
  static void resize(pointer_based_iterator<T> begin, SizeType *size, std::size_t new_size, Args &&...args);

  template <typename SizeType>
  static void assign(pointer_based_iterator<T> begin, SizeType *size, std::size_t count, T const &value);

  static void move_range(pointer_based_iterator<T> from, pointer_based_iterator<T> end,
                         pointer_based_iterator<T> to) noexcept(std::is_nothrow_move_constructible_v<T> &&
                                                                std::is_nothrow_move_assignable_v<T>);

  static std::size_t erase(pointer_based_iterator<T> pos, pointer_based_iterator<T> end, std::size_t size);

  static std::size_t erase(pointer_based_iterator<T> first, pointer_based_iterator<T> last,
  ...
  /// \param value  Element value to insert.
  template <typename SizeType>
  static pointer_based_iterator<T> insert(pointer_based_iterator<T> data, SizeType *size, pointer_based_iterator<T> pos,
  ...
  template <typename SizeType, typename... Args>
  static pointer_based_iterator<T> emplace(pointer_based_iterator<T> end, SizeType *size, pointer_based_iterator<T> pos,
                                           Args &&...args);
...
template <typename T>
template <typename SizeType, typename... Args>
void avbase<T>::init(pointer_based_iterator<T> begin, SizeType *const size, SizeType count, Args &&...args) {
  *size = 0;
  try {
...
template <typename T>
template <typename SizeType>
void avbase<T>::clear(SizeType *const size, pointer_based_iterator<T> const first,
...
template <typename T>
template <typename SizeType, typename... Args>
void avbase<T>::resize(pointer_based_iterator<T> const begin, SizeType *const size, std::size_t const new_size,
                       Args &&...args) {
...
template <typename T>
template <typename SizeType>
void avbase<T>::assign(pointer_based_iterator<T> begin, SizeType *const size, std::size_t count, T const &value) {
...
// ~~~~~~~~~~
template <typename T>
void avbase<T>::move_range(pointer_based_iterator<T> const from, pointer_based_iterator<T> const end,
                           pointer_based_iterator<T> const to) noexcept(std::is_nothrow_move_constructible_v<T> &&
                                                                        std::is_nothrow_move_assignable_v<T>) {
...
// ~~~~~
template <typename T>
std::size_t avbase<T>::erase(pointer_based_iterator<T> const pos, pointer_based_iterator<T> const end,
...
template <typename T>
std::size_t avbase<T>::erase(pointer_based_iterator<T> const first, pointer_based_iterator<T> const last,
                             pointer_based_iterator<T> const end, std::size_t const size) {
...
template <typename T>
template <typename SizeType>
pointer_based_iterator<T> avbase<T>::insert(pointer_based_iterator<T> const data, SizeType *const size,
...
template <typename T>
template <typename SizeType>
pointer_based_iterator<T> avbase<T>::insert(pointer_based_iterator<T> begin, SizeType *const size,
                                            pointer_based_iterator<T> pos,
                                            T &&value) noexcept(std::is_nothrow_move_constructible_v<T> &&
                                                                std::is_nothrow_move_assignable_v<T>) {
