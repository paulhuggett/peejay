...
class UriPctDecode : public testing::TestWithParam<std::tuple<std::string_view, std::string_view>> {};
...
// NOLINTNEXTLINE
INSTANTIATE_TEST_SUITE_P(UriPctDecode, UriPctDecode,
                         testing::Values(std::make_tuple(""sv, ""sv),                  // empty
