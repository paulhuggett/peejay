...
public:
  explicit boolean_value (bool b) noexcept : b_{b} {}
...
public:
  ...
  bool operator!= (null_value const &rhs) const noexcept {
    return !(*this == rhs);
  }
...
public:
  explicit number_long (long value) noexcept : value_{value} {}
...
public:
  explicit number_double (double value) noexcept : value_{value} {}
...
public:
  ...
  bool operator== (string_value const &rhs) const {
    return value_ == rhs.value_;
  }
...
public:
  ...
  explicit array_value (container_type v) noexcept : v_{std::move (v)} {}
