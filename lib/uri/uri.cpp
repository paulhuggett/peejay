...
auto sub_delims(rule const& r) {
  return r.single_char([](char const c) {
    ...
    return cp == code_point::exclamation_mark || cp == code_point::dollar_sign || cp == code_point::ampersand ||
           cp == code_point::apostrophe || cp == code_point::left_parenthesis || cp == code_point::right_parenthesis ||
           cp == code_point::asterisk || cp == code_point::plus_sign || cp == code_point::comma ||
...
auto unreserved(rule const& r) {
  return r.single_char([](char const c) {
    auto const cp = static_cast<code_point>(c);
    return static_cast<bool>(std::isalnum(static_cast<int>(c))) || cp == code_point::hyphen_minus ||
           cp == code_point::full_stop || cp == code_point::low_line || cp == code_point::tilde;
  });
}

// pct-encoded   = "%" HEXDIG HEXDIG
auto pct_encoded(rule const& r) {
  return r.concat(percent_sign).concat(hexdig).concat(hexdig).matched("pct-encoded", r);
}

// pchar         = unreserved / pct-encoded / sub-delims / ":" / "@"
auto pchar(rule const& r) {
  return r.alternative(unreserved, pct_encoded, sub_delims, colon, commercial_at).matched("pchar", r);
}
...
auto userinfo(rule const& r) {
  return r
      .star([](rule const& r2) {
        return r2.alternative(unreserved, pct_encoded, sub_delims, colon).matched("userinfo/*", r2);
      })
      .matched("userinfo", r);
}
...
auto scheme(rule const& r) {
  return r.concat(alpha)
      .star([](rule const& r2) { return r2.alternative(alpha, digit, plus, minus, full_stop).matched("scheme/*", r2); })
      .matched("scheme", r);
}
...
auto reg_name(rule const& r) {
  return r
      .star(
          [](rule const& r1) { return r1.alternative(unreserved, pct_encoded, sub_delims).matched("reg-name/*", r1); })
      .matched("reg-name", r);
}
...
auto ls32(rule const& r) {
  return r
      .alternative([](rule const& r1) { return r1.concat(h16).concat(colon).concat(h16).matched("h16:h16", r1); },
                   ipv4address)
      .matched("ls32", r);
}
...
auto ipv6address(rule const& r) {
  return r
      .alternative(
          [](rule const& r1) {
            // 6( h16 ":" ) ls32
            return r1.star(h16_colon, 6, 6).concat(ls32).matched("6( h16: ) ls32", r1);
          },
          [](rule const& r2) {
            // "::" 5( h16 ":" ) ls32
            return r2.concat(colon_colon).star(h16_colon, 5, 5).concat(ls32).matched("\"::\" 5( h16 colon ) ls32", r2);
          },
          [](rule const& r3) {
            // [ h16 ] "::" 4( h16 ":" ) ls32
          ...
          [](rule const& r4) {
            ...
            return r4
                .optional([](rule const& r4a) {
                  return r4a.star(h16_colon, 0, 1).concat(h16).matched("*1( h16 colon ) h16", r4a);
                })
                .concat(colon_colon)
                .star(h16_colon, 3, 3)
                .concat(ls32)
          ...
          [](rule const& r5) {
            ...
            return r5
                .optional([](rule const& r5a) {
                  return r5a.star(h16_colon, 0, 2).concat(h16).matched("*2( h16 colon ) h16", r5a);
                })
                .concat(colon_colon)
                .star(h16_colon, 2, 2)
                .concat(ls32)
          ...
          [](rule const& r6) {
            ...
            return r6
                .optional([](rule const& r6a) {
                  return r6a.star(h16_colon, 0, 3).concat(h16).matched("*3( h16 colon ) h16", r6a);
                })
                .concat(colon_colon)
                .concat(h16_colon)
                .concat(ls32)
          ...
          [](rule const& r7) {
            ...
            return r7
                .optional([](rule const& r7a) {
                  return r7a.star(h16_colon, 0, 4).concat(h16).matched("*4( h16 colon ) h16", r7a);
                })
                .concat(colon_colon)
                .concat(ls32)
          ...
          [](rule const& r8) {
            ...
            return r8
                .optional([](rule const& r8a) {
                  return r8a.star(h16_colon, 0, 5).concat(h16).matched("*5( h16 colon ) h16", r8a);
                })
                .concat(colon_colon)
                .concat(h16)
          ...
          [](rule const& r9) {
            ...
            return r9
                .optional([](rule const& r9a) {
                  return r9a.star(h16_colon, 0, 6).concat(h16).matched("*6( h16 colon ) h16", r9a);
                })
                .concat(colon_colon)
...
auto ipvfuture(rule const& r) {
  return r.concat(latin_small_letter_v)
      ...
      .star(
          [](rule const& r1) {
            return r1.alternative(unreserved, sub_delims, colon).matched("unreserved / sub-delims / colon", r1);
          },
          1)
      .matched("IPvFuture", r);
}
...
auto ip_literal(rule const& r) {
  return r.concat(left_square_bracket)
      .concat(
          [](rule const& r1) { return r1.alternative(ipv6address, ipvfuture).matched("IPv6address / IPvFuture", r1); })
...
auto host(rule const& r) {
  return r.alternative(ip_literal, ipv4address, reg_name).matched("IP-literal / IPv4address / reg-name", r);
}
constexpr auto hostfn = host;

auto host_rule(uri::parts& result) {
  return [&result](rule const& r) {
    return r.concat(hostfn, [&result](std::string_view host) { result.ensure_authority().host = host; })
        .matched("host", r);
  };
}
...
auto userinfo_at(uri::parts& result) {
  ...
  return [&result](rule const& r) {
    return r
        .concat(userinfo, [&result](std::string_view const userinfo) { result.ensure_authority().userinfo = userinfo; })
...
auto colon_port(uri::parts& result) {
  ...
  return [&result](rule const& r) {
    return r.concat(colon)
        .concat(port, [&result](std::string_view const p) { result.ensure_authority().port = p; })
        .matched("\":\" port", r);
  };
}
...
auto segment_nz_nc(rule const& r) {
  return r
      .star(
          [](rule const& r2) {
            return r2.alternative(unreserved, pct_encoded, sub_delims, commercial_at)
...
template <bool IsAbs> class append_dir {
public:
  explicit constexpr append_dir(uri::parts& result) noexcept : result_{result} {}
...
public:
  explicit constexpr append_segment(uri::parts& result) noexcept : result_{result} {}
...
public:
  explicit constexpr record_initial_segment(uri::parts& result) noexcept : result_{result} {}
  void operator()(std::string_view const seg) { result_.path.segments.emplace_back(seg); }
...
auto relative_part(uri::parts& result) {
  return [&result](rule const& r) {
    return r.alternative(auth_abempty(result), path_absolute(result), path_noscheme(result), path_empty)
...
auto query(rule const& r) {
  return r
      .star([](rule const& r2) {
        return r2.alternative(pchar, solidus, question_mark).matched(R"(pchar / "/" / "?")", r2);
      })
      .matched("query", r);
}
...
auto question_query(uri::parts& result) {
  return [&result](rule const& r) {
    return r
        ...
        .concat(query, [&result](std::string_view const query) { result.query = query; })
...
auto hash_fragment(uri::parts& result) {
  return [&result](rule const& rf) {
    return rf.concat(hash)
        .concat(fragment, [&result](std::string_view const fragment) { result.fragment = fragment; })
    ...
    return r.concat(relative_part(result))
        ...
        .optional([&result](rule const& rf) {
          ...
          return rf
              .concat(hash)  // "#"
              .concat(       // fragment
                  fragment, [&result](std::string_view const fragment) { result.fragment = fragment; })
              .matched("\"#\" fragment", rf);
        })
...
auto hier_part(uri::parts& result) {
  return [&result](rule const& r) {
    return r.alternative(auth_abempty(result), path_absolute(result), path_rootless(result), path_empty)
        .matched("hier-part", r);
  };
}
...
auto URI(uri::parts& result) {
  return [&result](rule const& r) {
    return r.concat(scheme, [&result](std::string_view const scheme) { result.scheme = scheme; })
        .concat(colon)
...
auto URI_reference(uri::parts& result) {
  return
      [&result](rule const& r) { return r.alternative(URI(result), relative_ref(result)).matched("URI-reference", r); };
}
...
bool parts::authority::valid() const noexcept {
  if (userinfo.has_value() && !rule{userinfo.value()}.concat(userinfofn).done()) {
    return false;
  }
...
bool parts::valid() const noexcept {
  if (!this->scheme.has_value() || !rule{this->scheme.value()}.concat(schemefn).done()) {
    return false;
  }
  ...
  if (this->query.has_value() && !rule{this->query.value()}.concat(queryfn).done()) {
    return false;
  }
  if (this->fragment.has_value() && !rule{this->fragment.value()}.concat(fragmentfn).done()) {
    return false;
  }
  return true;
}
...
std::optional<parts> join(std::string_view base, std::string_view reference, bool strict) {
