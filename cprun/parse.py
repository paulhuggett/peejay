...
#
# This table shows the Unicode General Category values that are referenced by
# ECMAScript grammar rules:
#
# General Category               | Formal Name | Grammar Rule
# ------------------------------ | ----------- | ---------------
# Combining spacing mark (Mc)    |             | IdentifierPart
...
# Other category (Zs)            | <USP>       | Whitespace
# Other letter (Lo)              |             | IdentifierStart
